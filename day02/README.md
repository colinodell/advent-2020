...
- `1-3 a: <em>a</em>b<em>c</em>de` is *valid*: position `1` contains `a` and position `3` does not.
- `1-3 b: <em>c</em>d<em>e</em>fg` is *invalid*: neither position `1` nor position `3` contains `b`.
- `2-9 c: c<em>c</em>cccccc<em>c</em>` is *invalid*: both position `2` and position `9` contain `c`.
