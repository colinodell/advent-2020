...
- If the bitmask bit is `X`, the corresponding memory address bit is <span title="Technically, since you're on a boat, they're all floating.">*floating*</span>.
...
```
000000000000000000000000000000<em>0</em>1101<em>0</em>  (decimal 26)
...
```
00000000000000000000000000000001<em>0</em>0<em>00</em>  (decimal 16)
