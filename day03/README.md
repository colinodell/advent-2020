...
The locations you'd check in the above example are marked here with `<em>O</em>` where there was an open square and `<em>X</em>` where there was a tree:
...
In this example, traversing the map using this slope would cause you to encounter `<em>7</em>` trees.
...
In the above example, these slopes would find `2`, `7`, `3`, `4`, and `2` tree(s) respectively; multiplied together, these produce the answer `<em>336</em>`.
